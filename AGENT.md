...
| ---- | -------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1    | 현재 상태 묘사 / 평소 루틴 (Description · Routine) | `place_description` (공간 설명), `routine` (나만의 루틴), `activity_description` (일상적인 활동 설명), `object_description` (사물 설명), `person_description` (인물 설명), `person_introduction` (인물 소개), `preference_description` (선호 설명), `preparation` (준비 과정 설명) |
| 2    | 과거 경험 · 최초/최근 기억 · 과거와 현재의 변화    | `first_experience` (첫 경험 설명), `recent_experience` (최근 경험 설명), `first_motivation` (첫 계기 설명), `experience_description` (과거 경험 설명), `past_present_change` (과거와 현재의 변화)                                                                                  |
| 3    | 특별·인상적·돌발 사건 (Memorable / Unexpected)     | `memorable_experience` (기억에 남는 경험), `problem_experience` (문제·돌발 경험)                                                                                                                                                                                                   |

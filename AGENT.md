...
`roleplayQuestionTypes` — 주제당 3문항

| id | 한글 | English |
|----|------|---------|
| `situation_questions` | 3,4가지 질문하기 | Ask 3-4 questions |
| `problem_solving` | 문제 대안 제시하기 | Suggest alternatives |
| `similar_experience` | 비슷한 경험 | Similar experience |
...
- Gemini API로 combo set 생성 → 기존 Topic에 `sets.push()` 또는 Topic 신규 생성
...
| `scripts/generate-question-bank.mjs` | Gemini 일일 combo set 생성 |
